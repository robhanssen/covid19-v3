---
title: "COVID19 in the United States"
author: "Rob Hanssen"
date: "12/20/2020"
output:
  html_document:
...
p1 <- casesdeaths %>% filter( date>="2020-02-01") %>%
...
To date (`r as.Date(today(), format="%b %d, %Y")`), there have been `r format(totalcases, big.mark=" ")` diagnosed cases of COVID19 and `r format(totaldeaths, big.mark=" ")` people have died as a results of COVID19.
